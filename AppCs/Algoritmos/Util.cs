public class Util{
    ...
    public static void MultiplyWithScalar(double[,] matrix, double[,] result, int rows, int cols, double scalar)
    {
    ...
    public static void Plus(double[,] A, double[,] B, double[,] Result, int Size)
    {
    ...
    /// <param name="Size">Tamaño de las matrices.</param>
    public static void Minus(double[,] A, double[,] B, double[,] Result, int Size)
    {
        for (int i = 0; i < Size; i++)
        {
            for (int j = 0; j < Size; j++)
    ...
    public double NormInf(double[,] matrix, int rows, int cols)
    {
